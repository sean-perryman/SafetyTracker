...
/* Helper function to show and hide the date fields and the has_field checkboxes. */


function showDateFields() {
  $('.training_cdl').removeClass('hidden');
  $('.training_has_cdl').addClass('hidden');
  $('.training_forklift').removeClass('hidden');
  $('.training_has_forklift').addClass('hidden');
  $('.training_passport').removeClass('hidden');
  $('.training_has_passport').addClass('hidden');
  $('.training_twic').removeClass('hidden');
  $('.training_has_twic').addClass('hidden');
  $('.training_chevron_bpso_opo').removeClass('hidden');
  $('.training_has_chevron_bpso_opo').addClass('hidden');
  $('.training_exxon').removeClass('hidden');
  $('.training_has_exxon').addClass('hidden');
  $('.training_msha').removeClass('hidden');
  $('.training_has_msha').addClass('hidden');
  $('.training_chevron_powerline').removeClass('hidden');
  $('.training_has_chevron_powerline').addClass('hidden');
  $('.training_oxy_psm_haz').removeClass('hidden');
  $('.training_has_oxy_psm_haz').addClass('hidden');
  $('.training_pdc_pass').removeClass('hidden');
  $('.training_has_pdc_pass').addClass('hidden');
  $('.training_nccco_crane_operator').removeClass('hidden');
  $('.training_has_nccco_crane_operator').addClass('hidden');
  $('.training_medical_exam_certificate').removeClass('hidden');
  $('.training_has_medical_exam_certificate').addClass('hidden');
  $('.training_api_rp2d_rigger_training').removeClass('hidden');
  $('.training_has_api_rp2d_rigger_training').addClass('hidden');
  $('.training_oecp').removeClass('hidden');
  $('.training_has_oecp').addClass('hidden');
}
